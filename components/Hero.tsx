  ...
  return (
    <div className="pb-20 pt-36">
      <div>
        ...
        />
        <Spotlight
          className="-top-28  left-80 h-[80vh] w-50[vw]  "
          fill="blue"
        />
      </div>
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify">
         ...
         <p className="text-center">
           Hi, I&apos;m Ahmed Thousif, a MERN stack Developer based in India
         </p>
